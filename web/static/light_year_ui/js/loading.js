    ...
    var pageLoader = function($mode) {
        ...
        if ($mode === 'show') {
            if ($loadingEl.length) {
                ...
                jQuery('body').prepend('<div id="lyear-loading" style="background-color: rgba(0,0,0,70%)"><div class="spinner-border text-primary" role="status"><span class="sr-only">Loading...</span></div></div>');
            }
        } else if ($mode === 'hide') {
            if ($loadingEl.length) {
